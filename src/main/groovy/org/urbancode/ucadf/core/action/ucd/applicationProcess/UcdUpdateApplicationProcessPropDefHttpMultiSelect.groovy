/**
 * This action updates an application process HTTP multi-select property definition.
 */
...
import org.urbancode.ucadf.core.model.ucd.property.UcdPropDefHttpMultiSelect
...
class UcdUpdateApplicationProcessPropDefHttpMultiSelect extends UcAdfAction {
	...
	public Object run() {
		...
		UcdPropDefHttpMultiSelect ucdPropDef = ucdApplicationProcess.getPropDefs().find {
			it.getName() == name
		}
		...
		if (ucdPropDef)	{
			...
			ucdPropDef = new UcdPropDefHttpMultiSelect()
		}
