/**
 * This action updates an application template process HTTP select property definition.
 */
package org.urbancode.ucadf.core.action.ucd.applicationTemplateProcess

import org.urbancode.ucadf.core.action.ucd.applicationProcess.UcdUpdateApplicationProcessPropDefHttpSelect
...
class UcdUpdateApplicationTemplateProcessPropDefHttpSelect extends UcAdfAction {
	// Action properties.
	...
	public Object run() {
		...
		logVerbose("Set application template [$applicationTemplate] process [$process] HTTP select property definition [$name].")
		...
		actionsRunner.runAction([
			action: UcdUpdateApplicationProcessPropDefHttpSelect.getSimpleName(),
			actionInfo: false,
